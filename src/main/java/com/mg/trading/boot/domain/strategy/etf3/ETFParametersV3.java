...
public class ETFParametersV3 extends AbstractParameters {
    ...
    public static ETFParametersV3 optimal() {
        return ETFParametersV3.builder()
                .totalLossThresholdPercent(BigDecimal.valueOf(5))
