...
public enum FinvizEndpoints {
    UNUSUAL_VOLUME("https://finviz.com/screener.ashx?v=111&f=cap_smallover,geo_usa,ind_stocksonly,sh_avgvol_o400,sh_insttrans_o20,sh_price_u10,sh_relvol_o2,ta_perf_dup,ta_volatility_wo4&ft=4&ta=0&o=-volume"),
    /**
