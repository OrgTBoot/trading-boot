...
public class DEMAV5CandlestickChart {
    ...
    public static void main(String[] args) {
        ...
        ChandelierExitLongIndicator chandLong = new ChandelierExitLongIndicator(series, 5, 3);
        ...
        dataset.addSeries(buildChartBarSeries(series, chandLong, "Chand"));
        dataset.addSeries(buildChartBarSeries(series, superTrend, "ST"));


        CandlestickChart chart = new CandlestickChart();
        chart.display(series, dataset, new DEMAStrategyDefinitionV5(symbol));
    }
